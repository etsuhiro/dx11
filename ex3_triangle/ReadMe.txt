========================================================================
    Win32 アプリケーション: ex3_triangle プロジェクトの概要
========================================================================

この ex3_triangle アプリケーションは、AppWizard により作成されました。

このファイルには、ex3_triangle アプリケーションを構成する各ファイルの内容の概要が含まれています。


ex3_triangle.vcxproj
...
ex3_triangle.ico
    これは、アプリケーションのアイコン (32x32) として使用されるアイコン ファイルです。このアイコンは、メイン リソース ファイル ex3_triangle.rc にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン ファイルです。このアイコンは、メイン リソース ファイル ex3_triangle.rc にインクルードされます。

/////////////////////////////////////////////////////////////////////////////
その他の標準ファイル :

StdAfx.h, StdAfx.cpp
    これらのファイルは、ex3_triangle.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。
