========================================================================
    Win32 アプリケーション: ex1_simple プロジェクトの概要
========================================================================

この ex1_simple アプリケーションは、AppWizard により作成されました。

このファイルには、ex1_simple アプリケーションを構成する各ファイルの内容の概要が含まれています。
...
ex1_simple.ico
    これは、アプリケーションのアイコン (32x32) として使用されるアイコン ファイルです。このアイコンは、メイン リソース ファイル ex1_simple.rc にインクルードされます。

small.ico
    これは、アプリケーションのアイコンの小さいバージョン (16x16) を含むアイコン ファイルです。このアイコンは、メイン リソース ファイル ex1_simple.rc にインクルードされます。

/////////////////////////////////////////////////////////////////////////////
その他の標準ファイル :

StdAfx.h, StdAfx.cpp
    これらのファイルは、ex1_simple.pch という名前のプリコンパイル済みヘッダー (PCH) ファイルと、StdAfx.obj という名前のプリコンパイル済みの型ファイルをビルドするために使用されます。
